...
import IUpdateChannelUseCase, { UpdateChannelInput } from "../../interfaces/useCases/channel/IUpdateChannelUseCase";
...
export default class UpdateChannelUseCase implements IUpdateChannelUseCase {
    ...
    async executeAsync(oldChannel: Partial<GuildChannel>, newChannel: UpdateChannelInput): Promise<GenericOutputDto<ChannelEntity>> {
        const channelAlready = await this.channelRepository.findByDiscordIdAsync(oldChannel.id);
